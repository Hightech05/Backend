...
// end delete
    const avatar = await uploadOnCloudinary(avatarLocalPath)
    if (!avatar.url) {
        throw new ApiError(400, "Error while uploadinf avatar")
    }
...
const getUserChannelProfile = asyncHandler(async(req, res)=> {
    ...
    return res
    .status(200)
    .json(new ApiResponse(200, channel[0], "user channel fetched successfuy"))
})
...
//     // get user details
//     // validation
//     // check if user is alrady exists:username , email
//     // check for images , check for avatar
//     // upload them to cloudinary
//     // create user object , entry in db
//     // send response , password and refresh token
//     // user cration , not be null
//     // return res.

//     const {fullname, email, username, password } = req.body    // console.log("email:", email);
//     // check validation
//     // if (fullname === "") {
